      ...
      <div className="container">
        ...
        <div className="row">
          <div className="six columns">
            ...
            <p className='zero'>Enter your password to edit the user link present at the bottom of the app. Download the mobile app from the <a href="//arhn.us/spotivity" target="_blank">Google Play Store</a>.</p>
          </div>
          <div className="u-cf"></div>
        </div>
        <p style={{ marginTop: 10 }}>current:{' '}
